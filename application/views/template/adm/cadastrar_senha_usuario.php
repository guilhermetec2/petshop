...
<div class="w3-padding-16" style="width:70vw;margin:auto">
    ...
    <?php echo form_open('usuario/cadastrar_senha_usuario',array('class' => 'w3-container w3-card-4')); ?>
        <br>
        <p>      
        <label class="w3-text-grey">Nome do Usuário</label>
        <input class="w3-input w3-border" type="text" name="nomeusuario" value="<?=$usuario['nomeusuario']?>" readOnly>
        </p>
        <p>      
        <label class="w3-text-grey">CPF</label>
        <input class="w3-input w3-border" type="text" name="cpf" value="<?=$usuario['cpf']?>" readOnly>
        </p>
        <p>      
        <label class="w3-text-grey">Cargo</label>
        <input class="w3-input w3-border" type="text" name="cargo" value="<?=$usuario['cargo']?>" readOnly>
        </p>
        <p>      
        <label class="w3-text-grey">email</label>
        <input class="w3-input w3-border" type="text" name="emailusuario" value="<?=$usuario['emailusuario']?>" readOnly>
        </p>
        <br>
        <div id="div-senha">
            <p>      
